  ...
  return (
    <html lang="en" className="scroll-smooth" data-scroll-behavior="smooth">
      <body className="bg-slate-50 text-slate-900 font-sans antialiased flex flex-col min-h-screen">
        ...
        {/* القائمة العلوية - تم إضافة زر المدونة هنا */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                {/* زر المدونة الجديد */}
                <Link href="/blog" className="text-slate-600 hover:text-blue-600 font-medium transition font-bold text-blue-600">Blog</Link>
                
                <Link href="/about" className="text-slate-600 hover:text-blue-600 font-medium transition">About Us</Link>
                <Link href="/contact" className="text-white bg-blue-600 px-5 py-2 rounded-lg font-medium hover:bg-blue-700 transition">Contact</Link>
              </div>
            </div>
          </div>
        </nav>
        ...
        {/* الفوتر - تم إضافة قسم المدونة هنا أيضاً لتقوية السيو */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="md:col-span-1 mb-8 md:mb-0">
                ...
                <p className="text-sm text-slate-400">
                  Helping Florida drivers find affordable, reliable auto insurance coverage.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><Link href="/blog" className="hover:text-white transition font-bold text-blue-400">Insurance Blog</Link></li>
                  <li><Link href="/privacy" className="hover:text-white transition">Privacy Policy</Link></li>
                  <li><Link href="/terms" className="hover:text-white transition">Terms of Service</Link></li>
                </ul>
              </div>

              {/* قسم أهم المدن - توليد تلقائي */}
              <div>
